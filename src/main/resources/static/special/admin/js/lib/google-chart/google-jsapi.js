...
if (!window['google']['loader']) {
    ...
    (function () {
        ...
        var w = function (a, b) {
            if (b) a = a.replace(n, "&amp;").replace(p, "&lt;").replace(q, "&gt;").replace(r, "&quot;").replace(t, "&#39;").replace(u, "&#0;"); else {
    ...
    google.loader.rfm({
        ":search": {
            ...
            "js": "default+en.I.js",
            "css": "default+en.css",
            "properties": {":Version": "1.0", ":NoOldNames": false, ":JSHash": "01d3e4019d02927b30f1da06094837dc"}
        },
        ":language": {
            "versions": {":1": "1", ":1.0": "1"},
            "path": "/api/language/1.0/777c339fbf96071a10c88d71b8d19085/",
            "js": "default+en.I.js",
            "properties": {":Version": "1.0", ":JSHash": "777c339fbf96071a10c88d71b8d19085"}
        },
        ":annotations": {
            "versions": {":1": "1", ":1.0": "1"},
